...
urlpatterns = [
    ...
    url(r'^logout/$', logout),
    url(r'^account_creation_page/$', account_creation_page),
    ...
    url(r'^search_account_names/$', search_account_names),
    ...
    url(r'^show_all_debit_and_credit_amount/$', show_all_debit_and_credit_amount),
